  ...
  return (
    <nav className="w-full flex justify-between p-4">
      ...
      <div className="flex items-center gap-4 w-1/3">
        <button className="border border-[#82ca9f] bg-[#82ca9f] font-sans uppercase text-white rounded-sm hover:border-[#82ca9f]  hover:bg-white hover:delay-75 hover:transition-all hover:duration-100 shadow-lg"
        onClick={handleOpenModal}
        >
          Add Book
        </button>
        <AddBookModal open={openModal} handleClose={handleCloseModal} />
